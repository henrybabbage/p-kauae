            ...
            <SmoothScroll>
                <Box id="about" bg="grey.900">
                    <Grid templateColumns="repeat(12, 1fr)" px={['6', '6', '6', '0', '0', '0']} w="100vw">
                        <GridItem colStart={1} colEnd={13} h="100vh" overflow="hidden" position="relative" bg="grey.900">
                        ...
                        <GridItem
                            ...
                            pb={['0', '0', '6', '6', '6', '6']}
                        >
                            <Flex pt="12" justify="center" flexDirection={'column'} height={['10vh', '10vh', '10vh', '25vh', '25vh', '25vh']}></Flex>
                        </GridItem>
                        <GridItem
                        ...
                        <GridItem
                            ...
                            pb={['6', '6', '6', '6', '6', '6']}
                        >
                            <Flex justify="center" flexDirection={'column'} height={'calc(100vh - var(--chakra-sizes-12))'}>
                                <Heading
                                    as="h2"
                                    fontFamily="heading"
                        ...
                        <GridItem
                            ...
                            height="auto"
                        >
                            <Flex as="div" justify="center" flexDirection="column" height={['40vh', '40vh', '100vh', '100vh', '100vh']} lineHeight="1.36">
                                <Heading
                                    as="h2"
                                    fontFamily="heading"
                        ...
                        <GridItem colStart={[1, 1, 1, 4, 4]} colEnd={[13, 13, 13, 12, 12]} pt={['16', '16', '16', '16', '16']}>
                            <CustomPortableText
                                as={'p'}
                                sx={{
                                    fontSize: ['24px', '24px', '24px', '32px', '32px', '32px'],
                        ...
                        <GridItem colStart={[1, 1, 1, 4, 4]} colEnd={[13, 13, 13, 12, 12]} pt={['6', '6', '6', '16', '16']}>
                            <CustomPortableText
                                as={'p'}
                                sx={{
                                    fontSize: ['24px', '24px', '24px', '32px', '32px', '32px'],
                        ...
                        <GridItem colStart={[1, 1, 1, 2, 2]} colEnd={[13, 13, 13, 12, 12]} pt={['6', '6', '6', '16', '16']}>
                        ...
                        <GridItem colStart={[1, 1, 1, 4, 4]} colEnd={[13, 13, 13, 12, 12]} pt={['6', '6', '6', '16', '16']} whiteSpace="pre-line">
                            <CustomPortableText
                                as={'p'}
                                sx={{
                                    fontSize: ['24px', '24px', '24px', '32px', '32px', '32px'],
                        ...
                        <GridItem colStart={[1, 1, 1, 4, 4, 4]} colEnd={[13, 13, 13, 12, 12, 12]} pt={['6', '6', '6', '16', '16']} whiteSpace="pre-line">
                            <CustomPortableText
                                as={'p'}
                                sx={{
                                    fontSize: ['24px', '24px', '24px', '32px', '32px', '32px'],
                ...
                <Box id="space" pt={['24', '24', '24', null, null, null]} h={[null, null, null, '50vh', '50vh', '50vh']} bg="grey.900" />
                <Box id="photographer" h={[null, null, null, '50vh', '50vh', '50vh']} bg="grey.900">
                    <Flex
                    ...
                    >
                        <Box w="84vw" pb={['10', '10', '10', '0', '0', '0']}>
                            <Flex
                                ...
                                color="white"
                            >
                                <Flex direction={['column', 'column', 'column', 'row', 'row', 'row']} alignItems="baseline">
                                    <Heading
                                ...
                                <Link href={`https://${kaiwhakaahua.paetukutuku}`} isExternal variant="menu">
                                    <Text fontFamily="heading" fontSize={['24px', '24px', '24px', '32px', '32px', '32px']} lineHeight="1.36" textAlign="left">
                                        <br />
                                        {photographerUrl}
                                    </Text>
                                </Link>
                        ...
                        >
                            <Flex direction="column" alignItems="baseline" justifyContent={['flex-end', 'flex-end', 'flex-end', null, null, null]}>
                                <ChakraNextImage
